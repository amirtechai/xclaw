...
export function listBindings(cfg: XClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: XClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: XClawConfig) {
