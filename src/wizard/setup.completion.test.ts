...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("xclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "xclaw");
