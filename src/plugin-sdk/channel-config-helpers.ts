...
type ChannelConfigAccessorParams<Config extends XClawConfig = XClawConfig> = {
  cfg: Config;
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends XClawConfig = XClawConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends XClawConfig = XClawConfig>(
...
> {
  const base = {
    resolveAllowFrom: ({ cfg, accountId }: { cfg: XClawConfig; accountId?: string | null }) =>
      mapAllowFromEntries(
...
function setTopLevelChannelEnabledInConfigSection<Config extends XClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends XClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends XClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
