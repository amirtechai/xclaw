...
import type { XClawPluginApi, XClawPluginConfigSchema } from "../plugins/types.js";
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerFull?: (api: XClawPluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: XClawConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
