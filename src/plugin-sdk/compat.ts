...
const shouldWarnCompatImport =
  ...
  process.env.XCLAW_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "xclaw/plugin-sdk/compat is deprecated for new plugins. Migrate to focused xclaw/plugin-sdk/<subpath> imports. See https://docs.xclaw.ai/plugins/sdk-migration",
    {
      code: "XCLAW_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.xclaw.ai/plugins/sdk-migration",
    },
  );
}
