...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof XClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: XClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: XClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
