...
import { normalizeXClawVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeXClawVersionBase(resolveRuntimeServiceVersion(env)) ??
    normalizeXClawVersionBase(plugin.version) ??
    plugin.version
  );
}
