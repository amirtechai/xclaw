...
export const PLUGIN_MANIFEST_FILENAME = "xclaw.plugin.json";
...
// package.json "xclaw" metadata (used for setup/catalog)
...
export type XClawPackageStartup = {
  /**
...
export type XClawPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: XClawPackageStartup;
};
...
): XClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
