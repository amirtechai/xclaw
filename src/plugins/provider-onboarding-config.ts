...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: XClawConfig, ...args: TArgs) => XClawConfig;
  applyConfig: (cfg: XClawConfig, ...args: TArgs) => XClawConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: XClawConfig, preset: TParams) => XClawConfig;
  primaryModelRef: string;
