...
export function applyGoogleGeminiModelDefault(cfg: XClawConfig): {
  next: XClawConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: XClawConfig): XClawConfig {
...
export function applyOpenAIConfig(cfg: XClawConfig): XClawConfig {
...
export function applyOpencodeGoModelDefault(cfg: XClawConfig): {
  next: XClawConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: XClawConfig): {
  next: XClawConfig;
  changed: boolean;
} {
