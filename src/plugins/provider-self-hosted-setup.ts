...
export function applyProviderDefaultModel(cfg: XClawConfig, modelRef: string): XClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: XClawConfig; modelId: string; modelRef: string; profileId: string } {
