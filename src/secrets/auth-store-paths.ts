...
export function listAuthProfileStorePaths(config: XClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: XClawConfig, stateDir: string): string[] {
