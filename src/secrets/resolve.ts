...
function resolveResolutionLimits(config: XClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: XClawConfig): SecretProviderConfig {
