...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: XClawConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: XClawConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: XClawConfig) => string;
  setAccountEnabled?: (params: {
    cfg: XClawConfig;
    accountId: string;
    enabled: boolean;
  }) => XClawConfig;
  deleteAccount?: (params: { cfg: XClawConfig; accountId: string }) => XClawConfig;
  isEnabled?: (account: ResolvedAccount, cfg: XClawConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: XClawConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: XClawConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: XClawConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: XClawConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.xclaw.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: XClawConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: XClawConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: XClawConfig; accountId?: string | null }) =>
    | {
