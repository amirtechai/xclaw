...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: XClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: XClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: XClawConfig): string {
