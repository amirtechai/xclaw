...
function createMatrixThreadCommandParams(commandBody: string, cfg: XClawConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: XClawConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",
