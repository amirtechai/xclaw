...
function resolveAcpStreamCoalesceIdleMs(cfg: XClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: XClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: XClawConfig): AcpProjectionSettings {
