...
function resolveAnthropicDefaultAuthMode(cfg: XClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: XClawConfig): XClawConfig {
...
export function applyTalkApiKey(config: XClawConfig): XClawConfig {
...
export function applyTalkConfigNormalization(config: XClawConfig): XClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: XClawConfig): XClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: XClawConfig): XClawConfig {
...
export function applyLoggingDefaults(cfg: XClawConfig): XClawConfig {
...
export function applyContextPruningDefaults(cfg: XClawConfig): XClawConfig {
...
export function applyCompactionDefaults(cfg: XClawConfig): XClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
