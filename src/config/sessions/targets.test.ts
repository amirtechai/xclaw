...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): XClawConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: XClawConfig, env: NodeJS.ProcessEnv) =>
