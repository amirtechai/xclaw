...
function resolveDefaultAccountId(cfg: XClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: XClawConfig): boolean {
...
export function summarizeBindings(cfg: XClawConfig, bindings: AgentBinding[]): string[] {
