...
function collectExecSafeBinScopes(cfg: XClawConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: XClawConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: XClawConfig): {
  config: XClawConfig;
  changes: string[];
  warnings: string[];
} {
