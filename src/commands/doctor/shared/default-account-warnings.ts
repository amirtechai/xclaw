...
export function collectMissingDefaultAccountBindingWarnings(cfg: XClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: XClawConfig): string[] {
  const warnings: string[] = [];
