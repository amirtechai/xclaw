...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set XCLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `xclaw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control XClaw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
