...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.XCLAW_SERVICE_MARKER;
  ...
  beforeEach(async () => {
    ...
    delete process.env.XCLAW_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.XCLAW_SERVICE_MARKER = originalServiceMarker;
    }
  });
