...
export function isAcpEnabledByPolicy(cfg: XClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: XClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: XClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: XClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: XClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: XClawConfig, agentId: string): boolean {
