...
import { loadConfig, writeConfigFile, type XClawConfig } from "../config/config.js";
...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: XClawConfig): boolean {
...
function resolveConfiguredAuthChannelInput(cfg: XClawConfig, mode: ChannelAuthMode): string {
