    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["xclaw directory self --channel slack", "Show the connected account identity."],
          [
            'xclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["xclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "xclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.xclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
