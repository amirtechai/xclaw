...
const SANDBOX_EXAMPLES = {
  main: [
    ["xclaw sandbox list", "List all sandbox containers."],
    ["xclaw sandbox list --browser", "List only browser containers."],
    ["xclaw sandbox recreate --all", "Recreate all containers."],
    ["xclaw sandbox recreate --session main", "Recreate a specific session."],
    ["xclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["xclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["xclaw sandbox list", "List all sandbox containers."],
    ["xclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["xclaw sandbox recreate --all", "Recreate all containers."],
    ["xclaw sandbox recreate --session main", "Recreate a specific session."],
    ["xclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["xclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["xclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["xclaw sandbox explain", "Show effective sandbox config."],
    ["xclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["xclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["xclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.xclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
