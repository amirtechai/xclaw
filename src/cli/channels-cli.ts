    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["xclaw channels list", "List configured channels and auth profiles."],
          ["xclaw channels status --probe", "Run channel status checks and probes."],
          [
            "xclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["xclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.xclaw.ai/cli/channels",
        )}\n`,
    );
