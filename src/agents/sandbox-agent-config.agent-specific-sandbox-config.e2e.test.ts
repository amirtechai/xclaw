...
async function resolveContext(config: XClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): XClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
