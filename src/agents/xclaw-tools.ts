...
const defaultXClawToolsDeps: XClawToolsDeps = {
  callGateway,
};

let xClawToolsDeps: XClawToolsDeps = defaultXClawToolsDeps;

export function createXClawTools(
  options?: {
  ...
  const resolvedConfig = options?.config ?? xClawToolsDeps.config;
  ...
  const tools: AnyAgentTool[] = [
    ...
    createSessionsListTool({
      ...
      callGateway: xClawToolsDeps.callGateway,
    }),
...
export const __testing = {
  setDepsForTest(overrides?: Partial<XClawToolsDeps>) {
    xClawToolsDeps = overrides
      ? {
          ...defaultXClawToolsDeps,
          ...overrides,
        }
      : defaultXClawToolsDeps;
  },
