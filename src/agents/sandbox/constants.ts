...
export const DEFAULT_SANDBOX_IMAGE = "xclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "xclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "xclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "xclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "xclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "xclaw-sandbox-browser";
