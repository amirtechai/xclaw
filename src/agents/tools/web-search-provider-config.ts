...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<XClawConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<XClawConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: XClawConfig): WebSearchConfig {
