...
export function resolveSessionToolsVisibility(cfg: XClawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: XClawConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: XClawConfig): AgentToAgentPolicy {
