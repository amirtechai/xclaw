...
export function resolveSubagentToolPolicy(cfg?: XClawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: XClawConfig["tools"]): string[] | undefined {
