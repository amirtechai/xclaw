...
function resolveAnthropicOpusThinking(cfg: XClawConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<XClawConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<XClawConfig>) {
