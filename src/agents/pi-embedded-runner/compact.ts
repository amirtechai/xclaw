...
function resolvePostCompactionIndexSyncMode(config?: XClawConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureXClawModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createXClawCodingTools({
      exec: {
