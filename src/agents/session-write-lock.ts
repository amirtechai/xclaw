...
const CLEANUP_STATE_KEY = Symbol.for("xclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("xclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("xclaw.sessionWriteLockWatchdogState");
