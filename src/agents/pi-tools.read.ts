...
function resolveAdaptiveReadMaxBytes(options?: XClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createXClawReadTool(base, {
...
export function createXClawReadTool(
  base: AnyAgentTool,
  options?: XClawReadToolOptions,
): AnyAgentTool {
