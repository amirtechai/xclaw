...
const defaultTools = createXClawCodingTools({ senderIsOwner: true });
...
describe("createXClawCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: XClawConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createXClawCodingTools({
    ...
    const anthropicTools = createXClawCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: XClawConfig = {
      tools: {
        exec: {
    ...
    const allowed = createXClawCodingTools({
    ...
    const denied = createXClawCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createXClawCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
