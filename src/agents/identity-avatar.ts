...
function resolveAvatarSource(cfg: XClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: XClawConfig, agentId: string): AgentAvatarResolution {
