...
const XCLAW_ATTRIBUTION_PRODUCT = "XClaw";
const XCLAW_ATTRIBUTION_ORIGINATOR = "xclaw";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: XCLAW_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: XCLAW_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${XCLAW_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
