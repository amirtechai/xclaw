...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("xclaw.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("xclaw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: XClawConfig): Promise<ContextEngine> {
