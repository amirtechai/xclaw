...
export function collectConfiguredModelPricingRefs(config: XClawConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: XClawConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
