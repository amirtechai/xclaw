...
describe("gateway auth", () => {
  ...
  it("resolves token/password from XCLAW gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          XCLAW_GATEWAY_TOKEN: "env-token",
          XCLAW_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides XCLAW_GATEWAY_PASSWORD", () => {
