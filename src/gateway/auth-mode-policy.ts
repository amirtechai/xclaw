...
export function hasAmbiguousGatewayAuthModeConfig(cfg: XClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: XClawConfig): void {
