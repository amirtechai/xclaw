...
export const A2UI_PATH = "/__xclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__xclaw__/canvas";

export const CANVAS_WS_PATH = "/__xclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.xclawCanvasA2UIAction.postMessage(...)
  // - Android: window.xclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["xclawCanvasA2UIAction"];
  ...
  globalThis.XClaw = globalThis.XClaw ?? {};
  globalThis.XClaw.postMessage = postToNode;
  globalThis.XClaw.sendUserAction = sendUserAction;
  globalThis.xclawPostMessage = postToNode;
  globalThis.xclawSendUserAction = sendUserAction;
