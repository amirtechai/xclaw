...
let originalXClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalXClawTestConsole = process.env.XCLAW_TEST_CONSOLE;
  process.env.XCLAW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalXClawTestConsole === undefined) {
    delete process.env.XCLAW_TEST_CONSOLE;
  } else {
    process.env.XCLAW_TEST_CONSOLE = originalXClawTestConsole;
  }
