...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.xclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", XCLAW_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.xclaw.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when XCLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.xclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when XCLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", XCLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.xclaw.jbphoenix.plist",
    },
    {
      name: "prefers XCLAW_LAUNCHD_LABEL over XCLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        XCLAW_PROFILE: "jbphoenix",
        XCLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from XCLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        XCLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty XCLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        XCLAW_PROFILE: "myprofile",
        XCLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.xclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
