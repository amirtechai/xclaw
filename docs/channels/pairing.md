...
read_when:
  ...
  - Reviewing XClaw security posture
title: "Pairing"
---

# Pairing

“Pairing” is XClaw’s explicit **owner approval** step.
...
Stored under `~/.xclaw/credentials/`:
...
3. On your phone, open the XClaw iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `xclaw nodes pending/approve`) is a
