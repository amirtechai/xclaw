...
- Install via CLI: `xclaw plugins install @xclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `xclaw plugins install ./extensions/zalo`
   - From npm (if published): `xclaw plugins install @xclaw/zalo`
...
This page reflects current XClaw behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `xclaw pairing list zalo`
  - `xclaw pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in XClaw.
...
- Example: `xclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `xclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `xclaw logs --follow`
