---
summary: "Messaging platforms XClaw can connect to"
read_when:
  - You want to choose a chat channel for XClaw
...
XClaw can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and XClaw will route per chat.
