...
XClaw has three related (but different) controls:
...
Use the inspector to see what XClaw is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:xclaw`: all built-in XClaw tools (excludes provider plugins)
