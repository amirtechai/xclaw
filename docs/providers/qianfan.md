---
summary: "Use Qianfan's unified API to access many models in XClaw"
read_when:
...
3. XClaw installed on your system
...
4. Copy the API key for use with XClaw

## CLI setup

```bash
xclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [XClaw Configuration](/gateway/configuration)
