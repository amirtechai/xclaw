---
summary: "Use NVIDIA's OpenAI-compatible API in XClaw"
read_when:
  - You want to use NVIDIA models in XClaw
...
xclaw onboard --auth-choice skip
xclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
