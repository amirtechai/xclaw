---
summary: "Use Xiaomi MiMo models with XClaw"
read_when:
  - You want Xiaomi MiMo models in XClaw
...
Xiaomi MiMo is the API platform for **MiMo** models. XClaw uses the Xiaomi
...
```bash
xclaw onboard --auth-choice xiaomi-api-key
# or non-interactive
xclaw onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
