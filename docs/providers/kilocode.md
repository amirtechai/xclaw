---
title: "Kilo Gateway"
summary: "Use Kilo Gateway's unified API to access many models in XClaw"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in XClaw
---
...
```bash
xclaw onboard --kilocode-api-key <key>
```
...
XClaw dynamically discovers available models from the Kilo Gateway at startup. Use
