---
summary: "Contributor guide for adding a new shared capability to the XClaw plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for XClaw core developers. If you are
  building an external plugin, see [Building Plugins](/plugins/building-plugins)
  instead.
</Info>

Use this when XClaw needs a new domain such as image generation, video
