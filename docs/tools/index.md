---
summary: "XClaw tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools XClaw provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Some plugins are **core** (shipped with XClaw), others are **external**
...
These tools ship with XClaw and are available without installing any plugins:
...
| `group:nodes`      | nodes                                                                                                     |
| `group:xclaw`   | All built-in XClaw tools (excludes plugin tools)                                                       |
