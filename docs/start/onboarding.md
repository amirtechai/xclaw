---
summary: "First-run setup flow for XClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give XClaw">
...
<Step title="CLI">
  ...
  The app can install the global `xclaw` CLI via npm/pnpm so terminal
