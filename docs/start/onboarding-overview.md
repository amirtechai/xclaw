---
summary: "Overview of XClaw onboarding options and flows"
read_when:
...
XClaw has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `xclaw onboard`                     | Launch the app            |
...
CLI command docs: [`xclaw onboard`](/cli/onboard)

## macOS app onboarding

Open the XClaw app. The first-run wizard walks you through the same steps
