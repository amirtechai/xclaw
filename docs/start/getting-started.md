---
summary: "Get XClaw installed and run your first chat in minutes."
read_when:
...
Install XClaw, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run XClaw as a service account or want custom paths:

- `XCLAW_HOME` — home directory for internal path resolution
- `XCLAW_STATE_DIR` — override the state directory
- `XCLAW_CONFIG_PATH` — override the config file path
