...
read_when:
  - You want Zalo Personal (unofficial) support in XClaw
...
Zalo Personal support for XClaw via a plugin, using native `zca-js` to automate a normal Zalo user account.
