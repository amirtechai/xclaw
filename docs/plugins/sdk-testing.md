...
summary: "Testing utilities and patterns for XClaw plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for XClaw
plugins.
...
**Import:** `xclaw/plugin-sdk/testing`
...
import { installCommonResolveTargetErrorCases } from "xclaw/plugin-sdk/testing";
...
import type { PluginRuntime } from "xclaw/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `xclaw/plugin-sdk` root barrel is rejected
...
XClaw uses Vitest with V8 coverage thresholds. For plugin tests:
