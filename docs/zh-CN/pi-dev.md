...
本指南总结了在 XClaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 XClaw 状态目录下。默认为 `~/.xclaw`。如果设置了 `XCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.xclaw.ai/testing
- https://docs.xclaw.ai/start/getting-started
