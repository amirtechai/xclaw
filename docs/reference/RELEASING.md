...
XClaw has three public release lanes:
...
- Run `RELEASE_TAG=vYYYY.M.D node --import tsx scripts/xclaw-npm-release-check.ts`
  (or the matching beta/correction tag) before approval
- After npm publish, run
  `node --import tsx scripts/xclaw-npm-postpublish-verify.ts YYYY.M.D`
...
- [`.github/workflows/xclaw-npm-release.yml`](https://github.com/xclaw/xclaw/blob/main/.github/workflows/xclaw-npm-release.yml)
- [`scripts/xclaw-npm-release-check.ts`](https://github.com/xclaw/xclaw/blob/main/scripts/xclaw-npm-release-check.ts)
- [`scripts/package-mac-dist.sh`](https://github.com/xclaw/xclaw/blob/main/scripts/package-mac-dist.sh)
- [`scripts/make_appcast.sh`](https://github.com/xclaw/xclaw/blob/main/scripts/make_appcast.sh)

Maintainers use the private release docs in
[`xclaw/maintainers/release/README.md`](https://github.com/xclaw/maintainers/blob/main/release/README.md)
