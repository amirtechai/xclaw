---
summary: "Host XClaw on a DigitalOcean Droplet"
read_when:
  - Setting up XClaw on DigitalOcean
  - Looking for a simple paid VPS for XClaw
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent XClaw Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `xclaw doctor --non-interactive` and check logs with `journalctl --user -u xclaw-gateway.service -n 50`.
