...
function enableSlackAccount(cfg: XClawConfig, accountId: string): XClawConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: XClawConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: XClawConfig; accountId: string }) =>
