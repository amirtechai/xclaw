...
import { type ChatCommandDefinition, type CommandArgs } from "xclaw/plugin-sdk/command-auth";
import {
...
import { chunkItems } from "xclaw/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "xclaw_cmdarg";
