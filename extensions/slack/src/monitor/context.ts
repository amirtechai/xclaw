...
import { resolveSessionKey, type SessionScope } from "xclaw/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "xclaw/plugin-sdk/config-runtime";
import { createDedupeCache } from "xclaw/plugin-sdk/infra-runtime";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("xclaw/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
