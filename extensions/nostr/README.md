...
Nostr DM channel plugin for XClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to XClaw. It enables your bot to:
...
# Configure xclaw to use local relay
