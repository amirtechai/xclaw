...
import type { XClawPluginApi } from "../runtime-api.js";
...
function readConfiguredDefaultAccountId(config: XClawPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<XClawPluginApi, "config">;
