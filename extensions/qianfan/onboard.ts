...
function resolveQianfanPreset(cfg: XClawConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: XClawConfig): XClawConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: XClawConfig): XClawConfig {
