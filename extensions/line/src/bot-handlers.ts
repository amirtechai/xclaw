...
import { hasControlCommand, resolveControlCommandGate } from "xclaw/plugin-sdk/command-auth";
...
import { evaluateMatchedGroupAccessForPolicy } from "xclaw/plugin-sdk/group-access";
import {
