import type { ChannelSetupInput } from "xclaw/plugin-sdk/channel-setup";
import type { XClawConfig } from "xclaw/plugin-sdk/config-runtime";
import { DEFAULT_ACCOUNT_ID } from "xclaw/plugin-sdk/routing";
import { hasConfiguredSecretInput } from "xclaw/plugin-sdk/secret-input";
import {
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "XClaw" "<shared-secret>" "<webhook-url>" --feature reaction',
