...
export function resolveTavilySearchConfig(cfg?: XClawConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: XClawConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: XClawConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
