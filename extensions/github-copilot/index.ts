import { ensureAuthProfileStore, listProfilesForProvider } from "xclaw/plugin-sdk/agent-runtime";
import { definePluginEntry, type ProviderAuthContext } from "xclaw/plugin-sdk/plugin-entry";
import { coerceSecretRef } from "xclaw/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "xclaw/plugin-sdk/provider-auth-login";
