...
vi.mock("xclaw/plugin-sdk/agent-runtime", () => ({
...
vi.mock("xclaw/plugin-sdk/config-runtime", async (importOriginal) => {
...
vi.mock("xclaw/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("xclaw/plugin-sdk/routing")>();
  return {
    ...actual,
...
vi.mock("xclaw/plugin-sdk/runtime-env", async (importOriginal) => {
  const actual = await importOriginal<typeof import("xclaw/plugin-sdk/runtime-env")>();
  const logger = {
    child: () => logger,
...
vi.mock("xclaw/plugin-sdk/text-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("xclaw/plugin-sdk/text-runtime")>();
  return {
    ...actual,
    redactIdentifier,
  };
...
vi.mock("../auth-store.js", () => ({
  WA_WEB_AUTH_DIR: "/tmp/xclaw-oauth/whatsapp/default",
  resolveDefaultWebAuthDir: () => "/tmp/xclaw-oauth/whatsapp/default",
