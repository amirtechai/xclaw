import { resolveIdentityNamePrefix } from "xclaw/plugin-sdk/agent-runtime";
import {
  resolveInboundSessionEnvelopeContext,
  toLocationContext,
} from "xclaw/plugin-sdk/channel-inbound";
import { formatInboundEnvelope } from "xclaw/plugin-sdk/channel-inbound";
import { createChannelReplyPipeline } from "xclaw/plugin-sdk/channel-reply-pipeline";
import { shouldComputeCommandAuthorized } from "xclaw/plugin-sdk/command-auth";
import type { loadConfig } from "xclaw/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "xclaw/plugin-sdk/config-runtime";
import { recordSessionMetaFromInbound } from "xclaw/plugin-sdk/config-runtime";
import { getAgentScopedMediaLocalRoots } from "xclaw/plugin-sdk/media-runtime";
import {
  buildHistoryContextFromEntries,
  type HistoryEntry,
} from "xclaw/plugin-sdk/reply-history";
import { resolveSendableOutboundReplyParts } from "xclaw/plugin-sdk/reply-payload";
import { resolveChunkMode, resolveTextChunkLimit } from "xclaw/plugin-sdk/reply-runtime";
import type { getReplyFromConfig } from "xclaw/plugin-sdk/reply-runtime";
...
} from "xclaw/plugin-sdk/routing";
import { logVerbose, shouldLogVerbose } from "xclaw/plugin-sdk/runtime-env";
import type { getChildLogger } from "xclaw/plugin-sdk/runtime-env";
import {
  readStoreAllowFromForDmPolicy,
  resolvePinnedMainDmOwnerFromAllowlist,
  resolveDmGroupAccessWithCommandGate,
} from "xclaw/plugin-sdk/security-runtime";
import { jidToE164, normalizeE164 } from "xclaw/plugin-sdk/text-runtime";
