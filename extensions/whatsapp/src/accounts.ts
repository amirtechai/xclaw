...
export function listWhatsAppAuthDirs(cfg: XClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: XClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: XClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: XClawConfig): ResolvedWhatsAppAccount[] {
