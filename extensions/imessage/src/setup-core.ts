...
export const imessageDmPolicy: ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: XClawConfig) => cfg.channels?.imessage?.dmPolicy ?? "pairing",
...
function resolveIMessageCliPath(params: { cfg: XClawConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure XClaw has Full Disk Access to Messages DB.",
