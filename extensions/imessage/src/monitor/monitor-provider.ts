...
import { createChannelPairingChallengeIssuer } from "xclaw/plugin-sdk/channel-pairing";
...
import { normalizeScpRemoteHost } from "xclaw/plugin-sdk/infra-runtime";
import { waitForTransportReady } from "xclaw/plugin-sdk/infra-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "xclaw/plugin-sdk/media-runtime";
...
import { danger, logVerbose, shouldLogVerbose, warn } from "xclaw/plugin-sdk/runtime-env";
 ...
 *   exec ssh -T xclaw@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., xclaw@192.168.64.3)
