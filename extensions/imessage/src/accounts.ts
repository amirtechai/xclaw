...
function mergeIMessageAccountConfig(cfg: XClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: XClawConfig): ResolvedIMessageAccount[] {
