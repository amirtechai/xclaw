...
import {
  ...
  type XClawConfig,
} from "xclaw/plugin-sdk/account-resolution";
import { isTruthyEnvValue } from "xclaw/plugin-sdk/infra-runtime";
import {
  listBoundAccountIds,
  resolveDefaultAgentBoundAccountId,
} from "xclaw/plugin-sdk/routing";
import { formatSetExplicitDefaultInstruction } from "xclaw/plugin-sdk/routing";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.XCLAW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: XClawConfig): string[] {
...
export function listTelegramAccountIds(cfg: XClawConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: XClawConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/xclaw/xclaw/issues/30673
...
export function listEnabledTelegramAccounts(cfg: XClawConfig): ResolvedTelegramAccount[] {
