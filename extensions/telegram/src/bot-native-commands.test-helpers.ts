...
import type { ChannelGroupPolicy } from "xclaw/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "xclaw/plugin-sdk/config-runtime";
...
type GetPluginCommandSpecsFn =
  typeof import("xclaw/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("xclaw/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("xclaw/plugin-sdk/plugin-runtime").executePluginCommand;
...
type RecordInboundSessionMetaSafeFn =
  typeof import("xclaw/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
...
vi.mock("xclaw/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("xclaw/plugin-sdk/reply-runtime", async (importOriginal) => {
...
vi.mock("xclaw/plugin-sdk/conversation-runtime", async (importOriginal) => {
...
vi.mock("xclaw/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("xclaw/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as XClawConfig)),
