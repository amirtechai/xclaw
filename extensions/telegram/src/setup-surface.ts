...
import type { ChannelSetupDmPolicy, ChannelSetupWizard } from "xclaw/plugin-sdk/setup";
...
function shouldShowTelegramDmAccessWarning(cfg: XClawConfig, accountId: string): boolean {
