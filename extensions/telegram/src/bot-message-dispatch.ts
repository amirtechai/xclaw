...
import { resolveAutoTopicLabelConfig, generateTopicLabel } from "xclaw/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: XClawConfig, agentId: string) {
  try {
