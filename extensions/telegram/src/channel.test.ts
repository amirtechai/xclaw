...
function createCfg(): XClawConfig {
  return {
    channels: {
      telegram: {
        enabled: true,
...
function resolveAccount(cfg: XClawConfig, accountId: string): ResolvedTelegramAccount {
  return telegramPlugin.config.resolveAccount(cfg, accountId) as ResolvedTelegramAccount;
}

function createStartTelegramContext(cfg: XClawConfig, accountId: string) {
...
function startTelegramAccount(cfg: XClawConfig, accountId: string) {
...
function configureOpsProxyNetwork(cfg: XClawConfig) {
