...
import { createFinalizableDraftLifecycle } from "xclaw/plugin-sdk/channel-lifecycle";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("xclaw.telegramDraftStreamState");
