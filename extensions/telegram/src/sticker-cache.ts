...
import { resolveApiKeyForProvider } from "xclaw/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "xclaw/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
...
import { loadJsonFile, saveJsonFile } from "xclaw/plugin-sdk/json-store";
import { AUTO_IMAGE_KEY_PROVIDERS, DEFAULT_IMAGE_MODELS } from "xclaw/plugin-sdk/media-runtime";
import { resolveAutoImageModel } from "xclaw/plugin-sdk/media-runtime";
import { describeImageFileWithModel } from "xclaw/plugin-sdk/media-understanding-runtime";
import { logVerbose } from "xclaw/plugin-sdk/runtime-env";
import { STATE_DIR } from "xclaw/plugin-sdk/state-paths";
