...
import type { GetReplyOptions, MsgContext } from "xclaw/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("xclaw/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as XClawConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("xclaw/plugin-sdk/media-runtime")>,
) {
...
vi.mock("xclaw/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("xclaw/plugin-sdk/agent-runtime", async (importOriginal) => {
