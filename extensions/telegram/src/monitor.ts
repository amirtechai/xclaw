...
import { resolveAgentMaxConcurrent } from "xclaw/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "xclaw/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: XClawConfig): RunOptions<unknown> {
  return {
    sink: {
