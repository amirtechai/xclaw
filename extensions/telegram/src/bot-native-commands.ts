...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): XClawConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: XClawConfig): TelegramAccountConfig => {
    try {
