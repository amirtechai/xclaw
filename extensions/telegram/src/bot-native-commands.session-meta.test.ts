...
type ResolveConfiguredBindingRouteFn =
  typeof import("xclaw/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
...
vi.mock("xclaw/plugin-sdk/command-auth", async (importOriginal) => {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/xclaw-sessions.json");
