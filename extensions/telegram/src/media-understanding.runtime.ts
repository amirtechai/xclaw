...
type DescribeImageWithModel =
  typeof import("xclaw/plugin-sdk/media-runtime").describeImageWithModel;
type TranscribeFirstAudio = typeof import("xclaw/plugin-sdk/media-runtime").transcribeFirstAudio;
