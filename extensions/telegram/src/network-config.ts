...
import type { TelegramNetworkConfig } from "xclaw/plugin-sdk/config-runtime";
import { isTruthyEnvValue } from "xclaw/plugin-sdk/infra-runtime";
import { isWSL2Sync } from "xclaw/plugin-sdk/infra-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "XCLAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "XCLAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "XCLAW_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable XCLAW_TELEGRAM_DNS_RESULT_ORDER
