...
import { createAccountListHelpers, type XClawConfig } from "../runtime-api.js";
...
export function listEnabledMattermostAccounts(cfg: XClawConfig): ResolvedMattermostAccount[] {
