...
>({
  ...
  resolveParams: (_cfg: XClawConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: XClawConfig): XClawConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-completions");
}

export function applyXaiResponsesApiConfig(cfg: XClawConfig): XClawConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: XClawConfig): XClawConfig {
