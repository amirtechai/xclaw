...
import { fetchWithSsrFGuard } from "xclaw/plugin-sdk/infra-runtime";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to XClaw workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".xclaw", "workspace", "media", "inbound");
 ...
 * Format matches XClaw's expected attachment structure.
 */
