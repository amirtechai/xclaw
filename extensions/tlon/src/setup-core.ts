...
export async function resolveTlonSetupConfigured(cfg: XClawConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: XClawConfig): Promise<string[]> {
