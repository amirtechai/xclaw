...
vi.mock("xclaw/plugin-sdk/web-media", async () => {
...
let loadWebMedia: typeof import("xclaw/plugin-sdk/web-media").loadWebMedia;
...
beforeAll(async () => {
  ...
  ({ loadWebMedia } = await import("xclaw/plugin-sdk/web-media"));
