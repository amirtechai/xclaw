...
export type DiscordConfig = NonNullable<XClawConfig["channels"]>["discord"];
...
export function createDiscordPreflightArgs(params: {
  ...
  return {
    ...
    accountId: "default",
    token: "token",
    runtime: {} as import("xclaw/plugin-sdk/runtime-env").RuntimeEnv,
    botUserId: params.botUserId ?? "xclaw-bot",
