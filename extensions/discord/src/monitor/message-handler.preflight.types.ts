...
import type { SessionBindingRecord } from "xclaw/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "xclaw/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "xclaw/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("xclaw/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("xclaw/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("xclaw/plugin-sdk/config-runtime").XClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
