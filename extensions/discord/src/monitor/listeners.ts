...
import { formatDurationSeconds } from "xclaw/plugin-sdk/infra-runtime";
...
type LoadedConfig = ReturnType<typeof import("xclaw/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("xclaw/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("xclaw/plugin-sdk/runtime-env").createSubsystemLogger>;
