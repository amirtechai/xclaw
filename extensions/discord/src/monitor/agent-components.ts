...
import { resolveHumanDelayConfig } from "xclaw/plugin-sdk/agent-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "xclaw/plugin-sdk/channel-inbound";
import { createChannelReplyPipeline } from "xclaw/plugin-sdk/channel-reply-pipeline";
...
import type { DiscordAccountConfig } from "xclaw/plugin-sdk/config-runtime";
import {
  buildPluginBindingResolvedText,
  parsePluginBindingApprovalCustomId,
  resolvePluginConversationBindingApproval,
} from "xclaw/plugin-sdk/conversation-runtime";
import { recordInboundSession } from "xclaw/plugin-sdk/conversation-runtime";
import { enqueueSystemEvent } from "xclaw/plugin-sdk/infra-runtime";
import { getAgentScopedMediaLocalRoots } from "xclaw/plugin-sdk/media-runtime";
import {
  dispatchPluginInteractiveHandler,
  type PluginInteractiveDiscordHandlerContext,
} from "xclaw/plugin-sdk/plugin-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "xclaw/plugin-sdk/reply-runtime";
...
import { logDebug, logError } from "xclaw/plugin-sdk/text-runtime";
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__xclaw_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__xclaw_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__xclaw_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__xclaw_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__xclaw_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__xclaw_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "XClaw form";
  customId = "__xclaw_discord_component_modal_wildcard__";
  components = [];
