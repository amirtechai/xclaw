...
import { getPluginCommandSpecs } from "xclaw/plugin-sdk/plugin-runtime";
...
import {
  ...
  shouldLogVerbose,
  warn,
} from "xclaw/plugin-sdk/runtime-env";
...
import { summarizeStringEntries } from "xclaw/plugin-sdk/text-runtime";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("xclaw/plugin-sdk/reply-history").HistoryEntry[]
    >();
