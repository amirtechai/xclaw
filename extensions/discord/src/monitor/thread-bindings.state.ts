...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "xclaw/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("xclaw.discordThreadBindingsState");
