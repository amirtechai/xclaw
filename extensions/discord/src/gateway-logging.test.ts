...
vi.mock("xclaw/plugin-sdk/runtime-env", () => ({
  logVerbose: vi.fn(),
}));

let logVerbose: typeof import("xclaw/plugin-sdk/runtime-env").logVerbose;
...
describe("attachDiscordGatewayLogging", () => {
  beforeEach(async () => {
    vi.resetModules();
    ({ logVerbose } = await import("xclaw/plugin-sdk/runtime-env"));
