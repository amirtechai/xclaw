...
import { normalizeAccountId } from "xclaw/plugin-sdk/account-id";
import { resolveAccountEntry } from "xclaw/plugin-sdk/routing";
import type { DiscordAccountConfig, DiscordActionConfig, XClawConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: XClawConfig): ResolvedDiscordAccount[] {
