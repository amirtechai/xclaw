...
function mergeZaloAccountConfig(cfg: XClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: XClawConfig): ResolvedZaloAccount[] {
