...
function resolveXClawVersion(): string {
  try {
 ...
 * and appends the XClaw version.
 *
 * Format: "teams.ts[apps]/<sdk-version> XClaw/<xclaw-version>"
 * Example: "teams.ts[apps]/2.0.5 XClaw/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} XClaw/${resolveXClawVersion()}`;
  return cachedUserAgent;
}
