...
This directory contains the **BlueBubbles external channel plugin** for XClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `xclaw/plugin-sdk` helpers.
