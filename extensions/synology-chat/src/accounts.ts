...
import { resolveDangerousNameMatchingEnabled } from "xclaw/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full XClaw config object. */
function getChannelConfig(cfg: XClawConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: XClawConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.XCLAW_BOT_NAME ?? "XClaw";
