...
vi.mock("xclaw/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("xclaw/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("xclaw/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("xclaw/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("xclaw/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("xclaw/plugin-sdk/webhook-ingress");
  return {
    ...actual,
