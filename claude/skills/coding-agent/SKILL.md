...
**⚠️ CRITICAL: Never review PRs in XClaw's own project folder!**
...
8. **NEVER start Codex in ~/.xclaw/** - it'll read your soul docs and get weird ideas about the org chart!
9. **NEVER checkout branches in ~/Projects/xclaw/** - that's the LIVE XClaw instance!
...
For long-running background tasks, append a wake trigger to your prompt so XClaw gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):

```
... your task here.

When completely finished, run this command to notify me:
xclaw system event --text "Done: [brief summary of what was built]" --mode now
```
...
When completely finished, run: xclaw system event --text \"Done: Built todos REST API with CRUD endpoints\" --mode now'"
```
