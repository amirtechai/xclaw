...
show_usage() {
    cat << EOF
clawlog - XClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View XClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    XClaw logs flow through the macOS unified log (subsystem: ai.xclaw).
