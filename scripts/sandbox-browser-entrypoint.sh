...
export DISPLAY=:1
export HOME=/tmp/xclaw-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${XCLAW_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${XCLAW_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${XCLAW_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${XCLAW_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${XCLAW_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${XCLAW_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${XCLAW_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${XCLAW_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${XCLAW_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${XCLAW_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${XCLAW_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
