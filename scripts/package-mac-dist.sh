...
# Output:
# - dist/XClaw.app
# - dist/XClaw-<version>.zip
# - dist/XClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.xclaw.mac}"
...
ZIP="$ROOT_DIR/dist/XClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/XClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/XClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/XClaw-$VERSION.dSYM.zip"
