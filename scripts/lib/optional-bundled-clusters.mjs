...
export const OPTIONAL_BUNDLED_BUILD_ENV = "XCLAW_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.xclaw?.install?.npmSpec === "string" &&
    packageJson.xclaw.install.npmSpec.trim().length > 0
  );
}
