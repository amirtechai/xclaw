...
- XCLAW_GATEWAY_VERSION = exact package.json version
- XCLAW_MARKETING_VERSION = short iOS/App Store version
- XCLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
XCLAW_GATEWAY_VERSION = ${PACKAGE_VERSION}
XCLAW_MARKETING_VERSION = ${MARKETING_VERSION}
XCLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
