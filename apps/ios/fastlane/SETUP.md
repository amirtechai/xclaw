...
ASC_KEYCHAIN_SERVICE=xclaw-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.xclaw.client
# or
...
- The beta flow regenerates `apps/ios/XClaw.xcodeproj` from `apps/ios/project.yml` before archiving
