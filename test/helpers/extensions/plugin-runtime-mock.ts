import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "xclaw/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "xclaw/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "xclaw/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/xclaw"),
    },
    modelAuth: {
