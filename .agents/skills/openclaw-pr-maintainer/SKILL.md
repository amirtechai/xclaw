---
name: xclaw-pr-maintainer
description: Maintainer workflow for reviewing, triaging, preparing, closing, or landing XClaw pull requests and related issues. Use when Codex needs to validate bug-fix claims, search for related issues or PRs, apply or recommend close/reason labels, prepare GitHub comments safely, check review-thread follow-up, or perform maintainer-style PR decision making before merge or closure.
---
...
- Use `--repo xclaw/xclaw` with `--match title,body` first.
...
```bash
gh search prs --repo xclaw/xclaw --match title,body --limit 50 -- "auto-update"
gh search issues --repo xclaw/xclaw --match title,body --limit 50 -- "auto-update"
gh search issues --repo xclaw/xclaw --match title,body --limit 50 \
